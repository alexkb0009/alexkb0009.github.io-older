...
{:.text-500}
- 8+ years exp. designing, developing, and administering web sites & applications, incl. personal & academic projects.
- Responsive front-end frameworks such as [Zurb Foundation](http://foundation.zurb.com/) and [Bootstrap](http://getbootstrap.com/).
...
{:.text-500}
- 4+ years exp. with Python, including web frameworks such as [Pyramid](https://trypyramid.com/), [Flask](http://flask.pocoo.org/), & [Bottle](http://bottlepy.org/) to create horizontally-scalable hybrid & single-page web applications and RESTful APIs (for usage with mobile applications); [Tornado](http://www.tornadoweb.org/) for WebSockets.
...
- 2+ years exp. with C# (incl. Windows Apps); academic experience with Java (distributed — sockets & CORBA).
